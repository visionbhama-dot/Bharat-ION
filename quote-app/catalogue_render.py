...
PRODUCTS = [
    ...
    {"key": "handblow", "cat": "PET Bottle Manufacturing", "name": "Hand-Feed Automatic PET Blowing Machine",
     ...
     "specs": [("Mould Cavities", "2 / 4"), ("Bottle Volume", "100 ml &ndash; 2 L"), ("Output", "Up to 3500 BPH"),
    ...
    {"key": "full", "cat": "PET Bottle Manufacturing", "name": "Fully Automatic PET Blowing Machine",
     ...
     "specs": [("Mould Cavities", "2 / 4 / 6"), ("Bottle Volume", "200 ml &ndash; 2 L"), ("Output", "Up to 6400 BPH"),
    ...
    {"key": "nozfill4", "cat": "Filling & Capping", "name": "4-Nozzle Semi-Automatic Filler",
     "lead": "A compact semi-automatic bottle filler with four nozzles for accurate, consistent filling of water and beverages \u2014 ideal for start-up and small bottling units.",
     "specs": [("Nozzles", "4"), ("Output", "500 &ndash; 1000 BPH"), ("Bottle Volume", "200 ml &ndash; 2 L"),
               ("Fill Type", "Gravity / Volumetric"), ("Contact Parts", "SS 304"), ("Operation", "Semi-Automatic")]},
    {"key": "rfc4", "cat": "Filling & Capping", "name": "Semi-Automatic RFC Filling 4-Head Machine",
     "lead": "A semi-automatic 3-in-1 rinsing, filling and capping machine with four heads \u2014 hygienic bottling in a compact footprint for small and medium plants.",
     "specs": [("Heads", "4 (Rinse-Fill-Cap)"), ("Output", "800 &ndash; 1500 BPH"), ("Bottle Volume", "200 ml &ndash; 2 L"),
               ("Rinsing", "Gripper type"), ("Capping", "Screw / Press"), ("Contact Parts", "SS 304")]},
]
...
EXTRA = {
    ...
    "nozfill4": {"model": "BIS-NF4",
                 "badges": [("1000", "BPH", "Max Output"), ("4", "Noz.", "Nozzles")],
                 "features": [("drop", "Drip-Free Filling"), ("gear", "Adjustable Volume"), ("shield", "SS 304 Contact"), ("wrench", "Easy to Clean")]},
    "rfc4": {"model": "BIS-RFC4",
             "badges": [("1500", "BPH", "Max Output"), ("4", "Head", "Rinse-Fill-Cap")],
             "features": [("gear", "3-in-1 Monobloc"), ("drop", "Hygienic Rinse"), ("shield", "SS 304 Contact"), ("clock", "Compact Footprint")]},
}
